...
<section class="self-stretch px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 py-8 sm:py-12 md:py-16 lg:py-20 xl:py-12 inline-flex flex-col justify-center items-center gap-2.5 overflow-hidden">
    <div class="self-stretch px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 rounded-[20px] sm:rounded-[30px] md:rounded-[40px] flex flex-col justify-center items-start gap-8 sm:gap-10 md:gap-12 lg:gap-14 overflow-hidden bg-dynamic-fade-medium"
         style="--bg-url: url('<?= htmlspecialchars($gradientSection->backgroundImageUrl) ?>')">
