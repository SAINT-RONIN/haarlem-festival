...
<div id="locations" class="w-full py-8 md:py-12 inline-flex flex-col justify-start items-center gap-2.5 overflow-hidden">
    <div class="hf-container w-full inline-flex flex-col justify-start items-start gap-2.5">
        ...
        <h2 class="self-stretch justify-start text-slate-800 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold"><?= htmlspecialchars($venue['venue_main_title'] ?? 'Overview of event locations') ?></h2>

        <div class="self-stretch inline-flex flex-col sm:flex-row justify-start items-start sm:items-center gap-3 md:gap-6">
            <div class="justify-start text-slate-800 text-lg md:text-2xl font-medium"><?= htmlspecialchars($venue['venue_filter_label'] ?? 'Showing all location') ?></div>
            <div class="flex flex-wrap justify-start items-center gap-3 md:gap-5">
                <div class="flex justify-start items-center gap-[3px]">
                    ...
                    <span class="justify-start text-black text-sm md:text-base font-normal leading-10"><?= htmlspecialchars($venue['venue_filter_jazz'] ?? 'Jazz') ?></span>
                </div>
                <div class="flex justify-start items-center gap-[3px]">
                    <div class="w-2.5 h-2.5 bg-orange-800 rounded-full"></div>
                    <span class="justify-start text-black text-sm md:text-base font-normal leading-10"><?= htmlspecialchars($venue['venue_filter_dance'] ?? 'Dance') ?></span>
                </div>
                <div class="flex justify-start items-center gap-[3px]">
                    <div class="w-2.5 h-2.5 bg-amber-400 rounded-full"></div>
                    <span class="justify-start text-black text-sm md:text-base font-normal leading-10"><?= htmlspecialchars($venue['venue_filter_history'] ?? 'History') ?></span>
                </div>
                <div class="flex justify-start items-center gap-[3px]">
                    <div class="w-2.5 h-2.5 bg-lime-700 rounded-full"></div>
                    <span class="justify-start text-black text-sm md:text-base font-normal leading-10"><?= htmlspecialchars($venue['venue_filter_restaurants'] ?? 'Restaurants') ?></span>
                </div>
                <div class="flex justify-start items-center gap-[3px]">
                    <div class="w-2.5 h-2.5 bg-violet-800 rounded-full"></div>
                    <span class="justify-start text-black text-sm md:text-base font-normal leading-10"><?= htmlspecialchars($venue['venue_filter_stories'] ?? 'Stories') ?></span>
                </div>
            </div>
        </div>
                ...
                <div class="w-full lg:w-[60%] rounded-2xl flex flex-col gap-2.5 min-h-0">
                    ...
                    <div class="self-stretch px-4 md:px-6 py-2.5 md:py-3.5 bg-white rounded-2xl shadow-[0px_0px_4px_0px_rgba(26,42,64,0.25)] flex flex-col md:flex-row justify-center items-center gap-2.5">
                        <div class="px-4 md:px-6 py-2.5 rounded-2xl flex justify-center items-center gap-2.5">
                            <span class="text-slate-800 text-lg md:text-xl font-bold"><?= htmlspecialchars($venue['venue_filter_title'] ?? 'Filter event:') ?></span>
                        </div>
                        <div class="px-px flex flex-wrap justify-center items-center gap-2 md:gap-3.5">
                            <button class="h-10 md:h-12 px-4 md:px-6 py-2 md:py-2.5 bg-pink-700 hover:bg-[#1A2A40] rounded-2xl outline outline-1 outline-offset-[-1px] outline-pink-700 hover:outline-[#1A2A40] flex justify-center items-center gap-2.5 transition-colors duration-200">
                                <span class="text-white text-base md:text-xl font-normal"><?= htmlspecialchars($venue['venue_filter_all'] ?? 'All') ?></span>
                            </button>
                            <button class="h-10 md:h-12 px-4 md:px-6 py-2 md:py-2.5 bg-white hover:bg-slate-800 rounded-2xl outline outline-1 outline-offset-[-1px] outline-slate-800 hover:outline-[#F5F1EB] flex justify-center items-center gap-2.5 transition-colors duration-200 group">
                                <span class="text-slate-800 group-hover:text-white text-base md:text-xl font-normal transition-colors duration-200"><?= htmlspecialchars($venue['venue_filter_jazz'] ?? 'Jazz') ?></span>
                            </button>
                            <button class="h-10 md:h-12 px-4 md:px-6 py-2 md:py-2.5 bg-white hover:bg-slate-800 rounded-2xl outline outline-1 outline-offset-[-1px] outline-slate-800 hover:outline-[#F5F1EB] flex justify-center items-center gap-2.5 transition-colors duration-200 group">
                                <span class="text-slate-800 group-hover:text-white text-base md:text-xl font-normal transition-colors duration-200"><?= htmlspecialchars($venue['venue_filter_dance'] ?? 'Dance') ?></span>
                            </button>
                            <button class="h-10 md:h-12 px-4 md:px-6 py-2 md:py-2.5 bg-white hover:bg-slate-800 rounded-2xl outline outline-1 outline-offset-[-1px] outline-slate-800 hover:outline-[#F5F1EB] flex justify-center items-center gap-2.5 transition-colors duration-200 group">
                                <span class="text-slate-800 group-hover:text-white text-base md:text-xl font-normal transition-colors duration-200"><?= htmlspecialchars($venue['venue_filter_history'] ?? 'History') ?></span>
                            </button>
                            <button class="h-10 md:h-12 px-4 md:px-6 py-2 md:py-2.5 bg-white hover:bg-slate-800 rounded-2xl outline outline-1 outline-offset-[-1px] outline-slate-800 hover:outline-[#F5F1EB] flex justify-center items-center gap-2.5 transition-colors duration-200 group">
                                <span class="text-slate-800 group-hover:text-white text-base md:text-xl font-normal transition-colors duration-200"><?= htmlspecialchars($venue['venue_filter_restaurants'] ?? 'Restaurants') ?></span>
                            </button>
                            <button class="h-10 md:h-12 px-4 md:px-6 py-2 md:py-2.5 bg-white hover:bg-slate-800 rounded-2xl outline outline-1 outline-offset-[-1px] outline-slate-800 hover:outline-[#F5F1EB] flex justify-center items-center gap-2.5 transition-colors duration-200 group">
                                <span class="text-slate-800 group-hover:text-white text-base md:text-xl font-normal transition-colors duration-200"><?= htmlspecialchars($venue['venue_filter_stories'] ?? 'Stories') ?></span>
                            </button>
                        </div>
                    </div>
