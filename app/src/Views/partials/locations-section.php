...
<section id="locations" class="w-full px-2 sm:px-4 md:px-8 lg:px-16 xl:px-24 py-4 sm:py-6 md:py-10 lg:py-12 flex flex-col justify-start items-start gap-2 sm:gap-2.5" aria-labelledby="locations-heading">
    ...
    <div class="self-stretch flex flex-col sm:flex-row justify-start items-start sm:items-center gap-2 sm:gap-3 md:gap-6" role="group" aria-label="Map legend">
        <span class="justify-start text-slate-800 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-medium"><?= htmlspecialchars($venue['venue_filter_label']) ?></span>
        <dl class="flex flex-wrap justify-start items-center gap-2 sm:gap-3 md:gap-5">
            <div class="flex justify-start items-center gap-1">
                <dt class="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-sky-600 rounded-full" aria-hidden="true"></dt>
            ...
            <div class="flex justify-start items-center gap-1">
                <dt class="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-orange-800 rounded-full" aria-hidden="true"></dt>
            ...
            <div class="flex justify-start items-center gap-1">
                <dt class="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-amber-400 rounded-full" aria-hidden="true"></dt>
            ...
            <div class="flex justify-start items-center gap-1">
                <dt class="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-lime-700 rounded-full" aria-hidden="true"></dt>
            ...
            <div class="flex justify-start items-center gap-1">
                <dt class="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-violet-800 rounded-full" aria-hidden="true"></dt>
            ...
            <div class="w-full lg:w-[60%] rounded-xl sm:rounded-2xl flex flex-col gap-1.5 sm:gap-2 md:gap-2.5 min-h-0">
                ...
                <div class="self-stretch px-2 sm:px-3 md:px-4 lg:px-6 py-2 sm:py-2.5 md:py-3 lg:py-3.5 bg-white rounded-xl sm:rounded-2xl shadow-[0px_0px_4px_0px_rgba(26,42,64,0.25)] flex flex-col md:flex-row justify-center items-center gap-1.5 sm:gap-2 md:gap-2.5" role="group" aria-label="Filter locations by category">
                    ...
                    <div class="flex flex-wrap justify-center items-center gap-1 sm:gap-1.5 md:gap-2 lg:gap-3.5" role="radiogroup" aria-label="Location category filter">
                        <button type="button" class="h-7 sm:h-8 md:h-10 lg:h-12 px-2 sm:px-3 md:px-4 lg:px-6 py-1 sm:py-1.5 md:py-2 lg:py-2.5 bg-pink-700 hover:bg-[#1A2A40] rounded-lg sm:rounded-xl md:rounded-2xl outline outline-1 outline-offset-[-1px] outline-pink-700 hover:outline-[#1A2A40] flex justify-center items-center transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-pink-700 focus-visible:ring-offset-2" aria-pressed="true">
                        ...
                        <button type="button" class="h-7 sm:h-8 md:h-10 lg:h-12 px-2 sm:px-3 md:px-4 lg:px-6 py-1 sm:py-1.5 md:py-2 lg:py-2.5 bg-white hover:bg-slate-800 rounded-lg sm:rounded-xl md:rounded-2xl outline outline-1 outline-offset-[-1px] outline-slate-800 hover:outline-[#F5F1EB] flex justify-center items-center transition-colors duration-200 group focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-800 focus-visible:ring-offset-2" aria-pressed="false">
