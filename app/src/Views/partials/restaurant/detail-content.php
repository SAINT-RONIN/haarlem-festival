        ...
        <div class="flex-1 flex flex-col gap-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div class="px-4 py-5 bg-white rounded-lg flex flex-col items-center gap-3">
                    ...
                    <span class="text-slate-800 text-xl font-medium font-['Montserrat']"><?= (int) ($r->durationMinutes / 60) ?> hours</span>
                </div>
                <?php endif; ?>
                ...
                <div class="px-4 py-5 bg-white rounded-lg flex flex-col items-center gap-3">
                    ...
                    <span class="text-slate-800 text-xl font-medium font-['Montserrat']"><?= $r->seatsPerSession ?> per session</span>
                </div>
                <?php endif; ?>
            </div>
