 ...
 *
 * Optional variable:
 * @var array|null $instructionsSection
 */

$title = $instructionsSection['title'] ?? 'How reservations work';
$cards = $instructionsSection['cards'] ?? null;
?>
        ...
        <?php else: ?>
            ...
            <div class="flex-1 max-w-sm mx-auto lg:mx-0 p-5 bg-white rounded-3xl flex flex-col justify-start items-start gap-3 shadow-sm">
                ...
                <div class="self-stretch flex flex-col justify-center items-center gap-3">
                    ...
                    <div class="self-stretch flex flex-col justify-start items-start gap-1.5">
                        <h3 class="self-stretch text-center text-slate-800 text-xl sm:text-2xl font-bold font-['Montserrat']">Browse</h3>
                        <p class="self-stretch text-center text-slate-600 text-sm sm:text-base font-normal font-['Montserrat'] leading-relaxed">
            ...
            <div class="flex-1 max-w-sm mx-auto lg:mx-0 p-5 bg-white rounded-3xl flex flex-col justify-start items-start gap-3 shadow-sm">
                ...
                <div class="self-stretch flex flex-col justify-center items-center gap-3">
                    ...
                    <div class="self-stretch flex flex-col justify-start items-start gap-1.5">
                        <h3 class="self-stretch text-center text-slate-800 text-xl sm:text-2xl font-bold font-['Montserrat']">Choose</h3>
                        <p class="self-stretch text-center text-slate-600 text-sm sm:text-base font-normal font-['Montserrat'] leading-relaxed">
            ...
            <div class="flex-1 max-w-sm mx-auto lg:mx-0 p-5 bg-white rounded-3xl flex flex-col justify-start items-start gap-3 shadow-sm">
                ...
                <div class="self-stretch flex flex-col justify-center items-center gap-3">
                    ...
                    <div class="self-stretch flex flex-col justify-start items-start gap-1.5">
                        <h3 class="self-stretch text-center text-slate-800 text-xl sm:text-2xl font-bold font-['Montserrat']">Reserve</h3>
                        <p class="self-stretch text-center text-slate-600 text-sm sm:text-base font-normal font-['Montserrat'] leading-relaxed">
