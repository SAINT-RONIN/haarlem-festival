            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
                <?php foreach ($cards as $card): ?>
                    ...
                    <article class="flex h-full flex-col overflow-hidden rounded-[24px] border border-slate-400 bg-white shadow-[0_1px_0_rgba(15,23,42,0.08)]"
                        ...
                        <div class="p-2 pb-0">
                            <?php if ($card->isVegan): ?>
                                <div class="flex h-[190px] w-full items-start justify-end rounded-[18px] bg-cover bg-center p-3 sm:h-[210px] xl:h-[175px]"
                                     style="background-image: url('<?= htmlspecialchars($card->image) ?>');">
