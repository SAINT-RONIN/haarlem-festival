<?php
/**
 * Hero partial - Reusable hero section for all pages.
 *
 * Required variables (set before including this partial):
 * @var \App\ViewModels\HeroData $heroData
...
<section id="hero"
         class="self-stretch px-1 sm:px-2 pb-1 sm:pb-2 flex flex-col justify-center items-center gap-3 sm:gap-5"
    ...
    <div class="self-stretch min-h-[500px] h-[calc(100vh-0.5rem)] sm:h-[calc(100vh-1rem)] rounded-bl-[20px] rounded-br-[20px] sm:rounded-bl-[30px] sm:rounded-br-[30px] md:rounded-bl-[50px] md:rounded-br-[50px] flex flex-col justify-between items-end relative hero-background-base"
         style="background-image: linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(0,0,0,0.5)), url('<?= htmlspecialchars($heroData->backgroundImageUrl) ?>');"
            ...
            <nav class="self-stretch bg-royal-blue rounded-xl sm:rounded-2xl flex flex-wrap xl:flex-nowrap justify-between items-center relative"
                ...
                <div id="hero-nav-menu" class="hidden xl:flex
                    ...
                    <a href="/" role="menuitem"
                       class="w-full xl:w-auto px-3 xl:px-3.5 2xl:px-4 py-2 <?= $currentPage === 'home' ? 'bg-red' : 'hover:bg-red' ?> rounded-lg flex justify-center items-center transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2" <?= $currentPage === 'home' ? 'aria-current="page"' : '' ?>>
                    ...
                    <a href="/jazz" role="menuitem"
                       class="w-full xl:w-auto px-3 xl:px-3.5 2xl:px-4 py-2 <?= $currentPage === 'jazz' ? 'bg-red' : 'hover:bg-red' ?> rounded-lg flex justify-center items-center transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2" <?= $currentPage === 'jazz' ? 'aria-current="page"' : '' ?>>
                    ...
                    <a href="/dance" role="menuitem"
                       class="w-full xl:w-auto px-3 xl:px-3.5 2xl:px-4 py-2 <?= $currentPage === 'dance' ? 'bg-red' : 'hover:bg-red' ?> rounded-lg flex justify-center items-center transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2" <?= $currentPage === 'dance' ? 'aria-current="page"' : '' ?>>
                    ...
                    <a href="/history" role="menuitem"
                       class="w-full xl:w-auto px-3 xl:px-3.5 2xl:px-4 py-2 <?= $currentPage === 'history' ? 'bg-red' : 'hover:bg-red' ?> rounded-lg flex justify-center items-center transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2" <?= $currentPage === 'history' ? 'aria-current="page"' : '' ?>>
                    ...
                    <a href="/restaurant" role="menuitem"
                       class="w-full xl:w-auto px-3 xl:px-3.5 2xl:px-4 py-2 <?= $currentPage === 'restaurant' ? 'bg-red' : 'hover:bg-red' ?> rounded-lg flex justify-center items-center transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2" <?= $currentPage === 'restaurant' ? 'aria-current="page"' : '' ?>>
                    ...
                    <a href="/storytelling" role="menuitem"
                       class="w-full xl:w-auto px-3 xl:px-3.5 2xl:px-4 py-2 <?= $currentPage === 'storytelling' ? 'bg-red' : 'hover:bg-red' ?> rounded-lg flex justify-center items-center transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2" <?= $currentPage === 'storytelling' ? 'aria-current="page"' : '' ?>>
                    ...
                    <?php else: ?>
                        <a href="/login" role="menuitem"
                           class="w-full xl:w-auto ml-1 2xl:ml-2 px-4 xl:px-5 2xl:px-6 py-2 bg-sand hover:bg-red rounded-lg flex justify-center items-center gap-2 transition-colors duration-200 group focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2" <?= $currentPage === 'login' ? 'aria-current="page"' : '' ?>>
        ...
        <div class="self-stretch px-3 sm:px-4 md:px-8 lg:px-16 xl:px-24 flex flex-col justify-center items-start">
            <h1 id="hero-heading"
                class="self-stretch text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-normal leading-tight"><?= htmlspecialchars($heroData->mainTitle) ?></h1>
            <p class="self-stretch text-white text-sm sm:text-base md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-light leading-snug"><?= htmlspecialchars($heroData->subtitle) ?></p>
        </div>
        ...
        <div class="self-stretch flex flex-col justify-start items-end">
            ...
            <div class="pr-2 sm:pr-3 md:pr-4 lg:pr-12 xl:pr-24 pl-2 sm:pl-3 md:pl-4 py-2 sm:py-3 md:py-4 lg:py-5 bg-sand rounded-tl-[12px] sm:rounded-tl-[15px] md:rounded-tl-[25px] lg:rounded-tl-[35px] flex justify-end items-start gap-1.5 sm:gap-2 md:gap-3 lg:gap-5">
                <div class="flex flex-row justify-start items-center gap-1.5 sm:gap-2 md:gap-3 lg:gap-5" role="group"
                    ...
                    <a href="<?= htmlspecialchars($heroData->primaryButtonLink) ?>"
                       class="p-1.5 sm:p-2 md:p-2.5 lg:p-3.5 bg-red hover:bg-royal-blue rounded-md sm:rounded-lg md:rounded-xl lg:rounded-2xl outline outline-1 outline-offset-[-1px] outline-red hover:outline-royal-blue flex justify-center items-center transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2">
                        <span class="text-center text-sand text-[10px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-normal whitespace-nowrap"><?= htmlspecialchars($heroData->primaryButtonText) ?></span>
                    ...
                    <a href="<?= htmlspecialchars($heroData->secondaryButtonLink) ?>"
                       class="p-1.5 sm:p-2 md:p-2.5 lg:p-3.5 bg-sand hover:bg-red rounded-md sm:rounded-lg md:rounded-xl lg:rounded-2xl outline outline-1 sm:outline-2 outline-offset-[-1px] sm:outline-offset-[-2px] outline-red flex justify-center items-center transition-colors duration-200 group focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2">
                        <span class="text-center text-red group-hover:text-sand text-[10px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-normal whitespace-nowrap transition-colors duration-200"><?= htmlspecialchars($heroData->secondaryButtonText) ?></span>
                    </a>
                </div>
            </div>
        </div>
