...
<div class="self-stretch px-1 sm:px-2 pb-1 sm:pb-2 flex flex-col justify-center items-center gap-3 sm:gap-5 overflow-hidden">
    <div class="self-stretch min-h-[500px] h-[calc(100vh-0.5rem)] sm:h-[calc(100vh-1rem)] rounded-bl-[20px] rounded-br-[20px] sm:rounded-bl-[30px] sm:rounded-br-[30px] md:rounded-bl-[50px] md:rounded-br-[50px] flex flex-col justify-between items-end overflow-hidden relative hero-background">
        ...
        <div class="w-full px-2 sm:px-4 md:px-6 lg:px-8 xl:px-16 2xl:px-24 py-2 sm:py-3 md:py-4 flex flex-col justify-center items-end gap-2.5 overflow-visible sticky top-0 z-50">
            <div class="self-stretch bg-slate-800 rounded-xl sm:rounded-2xl flex flex-wrap xl:flex-nowrap justify-between items-center relative">
                ...
                <a href="/" class="self-stretch px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 lg:py-2.5 rounded-xl sm:rounded-2xl flex justify-start items-center gap-1.5 sm:gap-2">
                    ...
                    <button id="hero-menu-btn" onclick="toggleHeroMenu()" class="xl:hidden p-2 sm:p-2.5 mr-1.5 sm:mr-2 text-stone-100 relative w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center">
        ...
        <div class="self-stretch px-3 sm:px-4 md:px-8 lg:px-16 xl:px-24 flex flex-col justify-center items-start overflow-hidden">
            <h1 class="self-stretch text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-normal leading-tight"><?= htmlspecialchars($hero['hero_main_title']) ?></h1>
        ...
        <div class="self-stretch flex flex-col justify-start items-end overflow-hidden">
            <div class="self-stretch h-4 sm:h-6 md:h-10 lg:h-16 xl:h-20"></div>
            <div class="pr-2 sm:pr-3 md:pr-4 lg:pr-12 xl:pr-24 pl-2 sm:pl-3 md:pl-4 py-2 sm:py-3 md:py-4 lg:py-5 bg-stone-100 rounded-tl-[12px] sm:rounded-tl-[15px] md:rounded-tl-[25px] lg:rounded-tl-[35px] flex justify-end items-start gap-1.5 sm:gap-2 md:gap-3 lg:gap-5 overflow-hidden">
                <div class="flex flex-row justify-start items-center gap-1.5 sm:gap-2 md:gap-3 lg:gap-5">
                    <a href="#events" class="p-1.5 sm:p-2 md:p-2.5 lg:p-3.5 bg-pink-700 hover:bg-[#1A2A40] rounded-md sm:rounded-lg md:rounded-xl lg:rounded-2xl outline outline-1 outline-offset-[-1px] outline-pink-700 hover:outline-[#1A2A40] flex justify-center items-center transition-colors duration-200">
                        ...
                        <div class="px-1 sm:px-1.5 lg:px-2 py-0.5 sm:py-1 lg:py-1.5 flex justify-center items-center">
                            <svg class="w-1 h-2 sm:w-1.5 sm:h-3 lg:w-2 lg:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </div>
                    </a>
                    <a href="#schedule" class="p-1.5 sm:p-2 md:p-2.5 lg:p-3.5 bg-stone-100 hover:bg-pink-700 rounded-md sm:rounded-lg md:rounded-xl lg:rounded-2xl outline outline-1 sm:outline-2 outline-offset-[-1px] sm:outline-offset-[-2px] outline-pink-700 flex justify-center items-center transition-colors duration-200 group">
