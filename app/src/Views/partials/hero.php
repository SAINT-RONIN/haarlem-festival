        ...
        <header class="w-full px-2 sm:px-4 md:px-6 lg:px-8 xl:px-16 2xl:px-24 py-2 sm:py-3 md:py-4 flex flex-col justify-center items-end gap-2.5 overflow-visible sticky top-0 z-50">
            <nav class="self-stretch bg-royal-blue rounded-xl sm:rounded-2xl flex flex-wrap xl:flex-nowrap justify-between items-center relative" aria-label="Main navigation">
                ...
                <a href="/" class="self-stretch px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 lg:py-2.5 rounded-xl sm:rounded-2xl flex justify-start items-center gap-1.5 sm:gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2">
                    ...
                    <button id="hero-menu-btn" onclick="toggleHeroMenu()" class="xl:hidden p-2 sm:p-2.5 mr-1.5 sm:mr-2 text-sand relative w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2 rounded-lg" aria-expanded="false" aria-controls="hero-nav-menu" aria-label="Toggle navigation menu">
                        <span class="sr-only">Toggle menu</span>
                        <div class="w-5 h-5 sm:w-6 sm:h-6 relative" aria-hidden="true">
                            <span id="hero-bar-1" class="absolute left-0 w-full h-0.5 bg-sand rounded transition-all duration-300 ease-in-out top-0"></span>
                            <span id="hero-bar-2" class="absolute left-0 w-full h-0.5 bg-sand rounded transition-all duration-300 ease-in-out top-1/2 -translate-y-1/2"></span>
                            <span id="hero-bar-3" class="absolute left-0 w-full h-0.5 bg-sand rounded transition-all duration-300 ease-in-out bottom-0"></span>
                        </div>
                    </button>
        ...
        <div class="self-stretch flex flex-col justify-start items-end">
            ...
            <div class="pr-2 sm:pr-3 md:pr-4 lg:pr-12 xl:pr-24 pl-2 sm:pl-3 md:pl-4 py-2 sm:py-3 md:py-4 lg:py-5 bg-sand rounded-tl-[12px] sm:rounded-tl-[15px] md:rounded-tl-[25px] lg:rounded-tl-[35px] flex justify-end items-start gap-1.5 sm:gap-2 md:gap-3 lg:gap-5">
                <div class="flex flex-row justify-start items-center gap-1.5 sm:gap-2 md:gap-3 lg:gap-5" role="group" aria-label="Hero call to action">
                    <a href="#events" class="p-1.5 sm:p-2 md:p-2.5 lg:p-3.5 bg-red hover:bg-royal-blue rounded-md sm:rounded-lg md:rounded-xl lg:rounded-2xl outline outline-1 outline-offset-[-1px] outline-red hover:outline-royal-blue flex justify-center items-center transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2">
                    ...
                    <a href="#schedule" class="p-1.5 sm:p-2 md:p-2.5 lg:p-3.5 bg-sand hover:bg-red rounded-md sm:rounded-lg md:rounded-xl lg:rounded-2xl outline outline-1 sm:outline-2 outline-offset-[-1px] sm:outline-offset-[-2px] outline-red flex justify-center items-center transition-colors duration-200 group focus:outline-none focus-visible:ring-2 focus-visible:ring-red focus-visible:ring-offset-2">
