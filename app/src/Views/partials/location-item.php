...
<button type="button" class="w-full flex justify-start items-start gap-1 sm:gap-[5px] group text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-pink-700 focus-visible:ring-offset-2 rounded-lg" aria-label="<?php echo $name; ?> - <?php echo $address; ?>">
    <span class="flex-1 p-2 sm:p-2.5 md:p-3 lg:p-3.5 bg-white group-hover:bg-gray-50 rounded-lg sm:rounded-[10px] outline outline-[0.50px] outline-offset-[-0.50px] outline-slate-800 flex flex-col justify-start items-start gap-0.5 sm:gap-1 transition-colors duration-200">
