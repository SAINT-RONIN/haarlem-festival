        ...
        <div class="self-stretch pt-4 sm:pt-6 md:pt-8 lg:pt-10 border-t-2 border-slate-800 flex flex-col justify-start items-start gap-4 sm:gap-6 md:gap-8 lg:gap-10">
            ...
            <div class="self-stretch flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 sm:gap-4 lg:gap-0 overflow-hidden">
                <div class="flex flex-wrap justify-start items-center gap-1 sm:gap-2 md:gap-3 lg:gap-5">
                    <a href="/" class="p-1.5 sm:p-2 md:p-2.5 border-b-2 border-slate-800 flex justify-center items-center gap-2.5 transition-colors duration-200">
                        <span class="text-center text-slate-800 text-sm sm:text-base md:text-lg lg:text-xl font-normal">Home</span>
                    </a>
                    <a href="/jazz" class="p-1.5 sm:p-2 md:p-2.5 border-b-2 border-transparent hover:border-slate-800 flex justify-center items-center gap-2.5 transition-all duration-200">
                        <span class="text-center text-slate-800 text-sm sm:text-base md:text-lg lg:text-xl font-normal">Jazz</span>
                    </a>
                    <a href="/dance" class="p-1.5 sm:p-2 md:p-2.5 border-b-2 border-transparent hover:border-slate-800 flex justify-center items-center gap-2.5 transition-all duration-200">
                        <span class="text-center text-slate-800 text-sm sm:text-base md:text-lg lg:text-xl font-normal">Dance</span>
                    </a>
                    <a href="/history" class="p-1.5 sm:p-2 md:p-2.5 border-b-2 border-transparent hover:border-slate-800 flex justify-center items-center gap-2.5 transition-all duration-200">
                        <span class="text-center text-slate-800 text-sm sm:text-base md:text-lg lg:text-xl font-normal">History</span>
                    </a>
                    <a href="/restaurant" class="p-1.5 sm:p-2 md:p-2.5 border-b-2 border-transparent hover:border-slate-800 flex justify-center items-center gap-2.5 transition-all duration-200">
                        <span class="text-center text-slate-800 text-sm sm:text-base md:text-lg lg:text-xl font-normal">Restaurants</span>
                    </a>
                    <a href="/storytelling" class="p-1.5 sm:p-2 md:p-2.5 border-b-2 border-transparent hover:border-slate-800 flex justify-center items-center gap-2.5 transition-all duration-200">
                ...
                <div class="flex justify-start items-center gap-3 sm:gap-4 md:gap-6">
                    <a href="#" class="h-8 sm:h-10 md:h-12 p-1 sm:p-[5px] rounded-[20px] flex justify-start items-center gap-1.5 sm:gap-2 md:gap-2.5 hover:text-pink-700 transition-colors duration-200">
