...
<article class="w-full lg:flex-1 bg-royal-blue rounded-[12px] sm:rounded-[16px] md:rounded-[20px] flex flex-col justify-start items-start overflow-hidden" aria-labelledby="<?php echo $dayId; ?>-heading">
    <!-- Day Header -->
    <header class="self-stretch p-3 sm:p-4 md:p-5 bg-royal-blue flex justify-start items-start gap-2 sm:gap-2.5 overflow-hidden">
        <time datetime="<?php echo date('Y') . '-' . $monthShort . '-' . $dayNumber; ?>" class="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-sand rounded-md sm:rounded-lg flex flex-col justify-center items-center" aria-hidden="true">
        ...
        <div class="flex-1 flex flex-col justify-start items-start">
            <h3 id="<?php echo $dayId; ?>-heading" class="self-stretch justify-start text-sand text-base sm:text-lg md:text-xl font-semibold leading-snug"><?php echo $dayName; ?>, <?php echo $monthShort; ?> <?php echo $dayNumber; ?></h3>
    ...
    <!-- Events List -->
    <ul class="self-stretch p-3 sm:p-4 md:p-5 bg-royal-blue flex flex-col justify-start items-start gap-1.5 sm:gap-2 md:gap-2.5 overflow-hidden list-none" role="list" aria-label="<?php echo $dayName; ?> events">
