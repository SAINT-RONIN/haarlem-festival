...
<div class="self-stretch p-2 sm:p-3 md:p-4 lg:p-6 xl:p-8 2xl:p-10 <?php echo $bgClass; ?> rounded-[12px] sm:rounded-[15px] md:rounded-[25px] lg:rounded-[40px] flex flex-col lg:flex-row justify-center items-center gap-2 sm:gap-3 lg:gap-4 xl:gap-8 2xl:gap-12 overflow-hidden">
    <?php if ($imageFirst): ?>
        <img class="w-full lg:flex-1 h-[140px] sm:h-[180px] md:h-[240px] lg:h-[220px] xl:h-[300px] 2xl:h-[400px] object-cover rounded-[10px] sm:rounded-[15px] md:rounded-[25px] lg:rounded-[40px]" src="<?php echo $imageSrc; ?>" alt="<?php echo $title; ?>">

        <div class="w-full lg:flex-1 flex flex-col justify-center items-start gap-1 sm:gap-1.5 lg:gap-2 xl:gap-2.5">
            <h3 class="<?php echo $titleClass; ?> text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold leading-tight"><?php echo $title; ?></h3>
    ...
    <?php else: ?>
        ...
        <img class="w-full lg:flex-1 h-[140px] sm:h-[180px] md:h-[240px] lg:h-[220px] xl:h-[300px] 2xl:h-[400px] object-cover rounded-[10px] sm:rounded-[15px] md:rounded-[25px] lg:rounded-[40px] order-1 lg:order-2" src="<?php echo $imageSrc; ?>" alt="<?php echo $title; ?>">
    <?php endif; ?>
</div>
