...
<div class="w-full min-h-[280px] sm:min-h-[350px] md:min-h-[500px] lg:min-h-[650px] xl:min-h-[760px] px-2 sm:px-4 md:px-8 lg:px-16 xl:px-24 py-4 sm:py-6 md:py-10 lg:py-12 flex flex-col justify-center items-center gap-2.5 overflow-hidden">
    <div class="self-stretch flex-1 px-3 sm:px-4 md:px-8 lg:px-12 py-4 sm:py-5 md:py-6 lg:py-7 bg-gradient-to-b from-black/0 to-black/80 rounded-[15px] sm:rounded-[20px] md:rounded-[30px] lg:rounded-[40px] flex flex-col justify-end items-start gap-2 sm:gap-3 md:gap-4 lg:gap-5 overflow-hidden" style="background: linear-gradient(to bottom, rgba(0,0,0,0), rgba(0,0,0,0.8)), url('/assets/Image/explore-incoming-events.png') center/cover;">
