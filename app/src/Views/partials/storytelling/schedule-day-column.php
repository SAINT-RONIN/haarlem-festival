<?php
/**
 * Storytelling schedule day column partial.
 *
 * @var \App\ViewModels\Schedule\StorytellingScheduleDayViewModel $day
 * @var int $dayIndex
 * @var string $dayItemClasses Dynamic classes for responsive layout
 * @var \App\ViewModels\Schedule\StorytellingScheduleViewModel $schedule
 */
