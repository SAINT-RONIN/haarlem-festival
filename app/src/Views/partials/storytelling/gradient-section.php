<?php
/**
 * Gradient section partial for storytelling page.
...
<section
        class="self-stretch px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 py-8 sm:py-12 md:py-16 lg:py-20 xl:py-12 inline-flex flex-col justify-center items-center gap-2.5 overflow-hidden">
