...
$layout = new PublicPageLayout(contentTemplates: [
    new ViewTemplate(__DIR__ . '/../partials/home/explore-banner.php', [
        'exploreBanner' => $viewModel->exploreBanner,
    ]),
    new ViewTemplate(__DIR__ . '/../partials/home/intro-section.php', [
        'introSection' => $viewModel->introSection,
    ]),
    new ViewTemplate(__DIR__ . '/../partials/home/events-showcase-section.php', [
        'eventsHeader' => $viewModel->eventsHeader,
        'eventTypes' => $viewModel->eventTypes,
    ]),
    new ViewTemplate(__DIR__ . '/../partials/home/locations-section.php', [
        'locationsSection' => $viewModel->locationsSection,
        'locations' => $viewModel->locations,
    ]),
    new ViewTemplate(__DIR__ . '/../partials/home/schedule-section.php', [
