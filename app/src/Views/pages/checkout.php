                ...
                <div class="p-4 sm:p-6 bg-white rounded-3xl flex flex-col gap-4">
                    ...
                    <div class="p-2.5 flex flex-col gap-6">
                        ...
                        <div class="px-3 sm:px-3.5 py-3.5 rounded-2xl outline outline-2 outline-offset-[-2px] outline-gray-300 flex flex-col gap-3.5">
                            ...
                            <label class="px-3 py-2.5 bg-white rounded-2xl outline outline-2 outline-offset-[-2px] outline-gray-200
                                ...
                                <svg class="w-7 h-7 text-gray-600 flex-shrink-0" viewBox="0 0 24 24" fill="none"
                                     stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                     aria-hidden="true">
                                    <path d="M7 21h-1a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2h-1"></path>
                                    <path d="M12 17v-6"></path>
                                    <path d="M9.5 14.5L12 17l2.5-2.5"></path>
                                </svg>
                                <div class="flex-1 flex flex-col gap-0.5">
                                    <span class="text-gray-900 text-base font-normal font-['Montserrat'] leading-5">PayPal</span>
                                    <span class="text-gray-500 text-xs sm:text-sm font-normal font-['Montserrat'] leading-4">Fast &amp; secure</span>
                                </div>
                        ...
                        <div class="p-3.5 rounded-2xl outline outline-2 outline-offset-[-2px] outline-gray-300 flex flex-col gap-3.5">
                            ...
                            <button type="button"
                                    id="js-pay-btn"
                                    class="self-stretch h-12 sm:h-14 bg-gray-400 rounded-[10px] inline-flex justify-center items-center gap-2
