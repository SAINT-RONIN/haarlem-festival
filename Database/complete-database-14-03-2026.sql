...
--
-- Host: mysql
-- Generation Time: Mar 14, 2026 at 01:54 PM
...
(225, 40, 'intro_body', 'HEADING', 'Yummy Gourmet with a Twist', NULL, NULL, '2026-02-16 13:38:26'),
(226, 42, 'hero_main_title', 'TEXT', 'Discover 7 gourmet restaurants offering exclusive festival\r\nmenus crafted by top local chefs.', NULL, NULL, '2026-03-07 15:38:22'),
(227, 42, 'hero_button_primary', 'BUTTON_TEXT', 'Discover restaurants', NULL, NULL, '2026-02-16 13:38:26'),
(228, 42, 'hero_button_primary_link', 'LINK', '#restaurants', NULL, NULL, '2026-02-16 13:38:26'),
(229, 42, 'hero_button_secondary', 'BUTTON_TEXT', 'About Yummy', NULL, NULL, '2026-02-16 13:38:26'),
(230, 42, 'hero_button_secondary_link', 'LINK', '#about', NULL, NULL, '2026-02-16 13:38:26'),
(231, 45, 'gradient_heading', 'IMAGE_PATH', '/assets/Image/restaurants/hero-picture.png', NULL, NULL, '2026-02-16 13:38:26'),
(232, 45, 'gradient_subheading', 'HEADING', 'Good food tastes better when shared!', NULL, NULL, '2026-02-16 15:29:20'),
(233, 40, 'intro_heading', 'TEXT', 'Food, stories, and shared moments across Haarlem.', NULL, NULL, '2026-02-16 13:38:26'),
(234, 51, 'route_location1_name', 'IMAGE_PATH', '/assets/Image/restaurants/chef-preparing-food.png', NULL, NULL, '2026-02-16 13:38:26'),
(235, 51, 'route_location1_description', 'HEADING', 'Yummy! at the Heart of the Festival', NULL, NULL, '2026-02-16 13:38:26'),
(236, 51, 'route_location2_name', 'TEXT', 'Welcome to Yummy!, the food experience of the Haarlem Festival.\r\nFour days where some of the city\'s favorite restaurants open their doors with special menus made just for this event.', NULL, NULL, '2026-03-07 15:14:05'),
(237, 51, 'route_location2_description', 'IMAGE_PATH', '/assets/Image/restaurants/table-with-food-and-drink.png', NULL, NULL, '2026-02-16 13:38:26'),
(238, 51, 'route_location3_name', 'TEXT', 'Yummy! at the Heart of the Festival', NULL, NULL, '2026-02-16 13:38:26'),
(239, 51, 'route_location3_description', 'HEADING', 'When Haarlem Becomes a Dining Room', NULL, NULL, '2026-02-16 13:38:26'),
(240, 51, 'route_location4_name', 'TEXT', 'As the sun sets over Haarlem\'s historic streets, the city slowly turns into one big dining room.\r\n\r\nFrom Thursday to Sunday, each restaurant offers 2 to 3 sessions later afternoon, starting from 16:30 and lasting around 1.5 to 2 hours..\r\n\r\nJust enough time to enjoy your plate, share a toast, and wander to the next event or performance nearby.', NULL, NULL, '2026-03-07 15:38:22'),
(241, 51, 'route_location4_description', 'IMAGE_PATH', '/assets/Image/restaurants/food-in-canal.png', NULL, NULL, '2026-02-16 13:38:26'),
(242, 51, 'route_location5_name', 'TEXT', 'When Haarlem Becomes a Dining Room', NULL, NULL, '2026-02-16 13:38:26'),
(243, 51, 'route_location5_description', 'HEADING', 'How reservations work', NULL, NULL, '2026-02-16 13:38:26'),
(244, 51, 'route_location6_name', 'HEADING', 'Browse', NULL, NULL, '2026-02-16 13:38:26'),
(245, 51, 'route_location6_description', 'TEXT', 'Explore participating restaurants and their exclusive festival menus.', NULL, NULL, '2026-02-16 13:38:26'),
(246, 51, 'route_location7_name', 'HEADING', 'Choose', NULL, NULL, '2026-02-16 13:38:26'),
(247, 51, 'route_location7_description', 'TEXT', 'Pick a date and time slot that fits your schedule.', NULL, NULL, '2026-02-16 13:38:26'),
(248, 51, 'route_location8_name', 'HEADING', 'Reserve', NULL, NULL, '2026-02-16 13:38:26'),
(249, 51, 'route_location8_description', 'TEXT', 'Complete your booking and receive a confirmation. Done!', NULL, NULL, '2026-02-16 13:38:26'),
(250, 51, 'route_location9_name', 'HEADING', 'Explore the participant restaurants', NULL, NULL, '2026-02-16 13:38:26'),
(251, 51, 'route_location9_description', 'TEXT', 'Discover all restaurants participating in Yummy! Each one offers a special festival menu, unique flavors, and limited time slots throughout the weekend.', NULL, NULL, '2026-02-16 13:38:26'),
...
--
ALTER TABLE `CmsItem`
  MODIFY `CmsItemId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=665;
...
--
ALTER TABLE `CmsSection`
  MODIFY `CmsSectionId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
